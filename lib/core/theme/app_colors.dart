...
class AppColors {
  ...
  static const Color reviewRequested   = Color(0xFF5B34A3);
  static const Color reviewRequestedBg = Color(0xFFEEEDFE);
  ...
  static Color statusColor(TaskStatus s) {
    switch (s) {
      case TaskStatus.inProgress:      return inProgress;
      case TaskStatus.reviewRequested: return reviewRequested;
      case TaskStatus.completed:       return completed;
      case TaskStatus.onHold:          return onHold;
      default:                         return pending;
    }
  }
  static Color statusBg(TaskStatus s) {
    switch (s) {
      case TaskStatus.inProgress:      return inProgressBg;
      case TaskStatus.reviewRequested: return reviewRequestedBg;
      case TaskStatus.completed:       return completedBg;
      case TaskStatus.onHold:          return onHoldBg;
      default:                         return pendingBg;
    }
  }
  static const List<Color> avatarBgs = [Color(0xFFE1F5EE),Color(0xFFFAEEDA),Color(0xFFEEEDFE),Color(0xFFFAECE7),Color(0xFFE6F1FB)];
  static const List<Color> avatarFgs = [Color(0xFF085041),Color(0xFF633806),Color(0xFF3C3489),Color(0xFF712B13),Color(0xFF0C447C)];
  static Color avatarBg(int i) => avatarBgs[i % avatarBgs.length];
  static Color avatarFg(int i) => avatarFgs[i % avatarFgs.length];
}
